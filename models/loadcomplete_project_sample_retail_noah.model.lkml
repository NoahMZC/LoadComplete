connection: "loadcomplete_sample_retail_noah"

# include all the views
include: "/views/**/*.view"

datagroup: loadcomplete_project_sample_retail_noah_default_datagroup {
  # sql_trigger: SELECT MAX(id) FROM etl_log;;
  max_cache_age: "1 hour"
}

persist_with: loadcomplete_project_sample_retail_noah_default_datagroup
